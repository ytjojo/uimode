...
public class ColorStateCreator implements ICreateColorState {
    ...
    private CachedTypedValueArray textTa;

    ColorStateCreator(CachedTypedValueArray textTa) {
        this.textTa = textTa;
    }
    ...
    private void setStateColor(CachedTypedValueArray selectorTa, int attr, @AttrRes int functionId) {
