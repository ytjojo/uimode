...
public class ButtonDrawableCreator implements ICreateDrawable {
    ...
    private CachedTypedValueArray buttonTa;

    public ButtonDrawableCreator(CachedTypedValueArray typedArray, CachedTypedValueArray buttonTa) {
    ...
    private void setSelectorDrawable(CachedTypedValueArray typedArray, CachedTypedValueArray buttonTa,
