...
public class SelectorDrawableCreator implements ICreateDrawable {
    ...
    private CachedTypedValueArray selectorTa;

    public SelectorDrawableCreator(CachedTypedValueArray typedArray, CachedTypedValueArray selectorTa) {
    ...
    private void setSelectorDrawable(CachedTypedValueArray typedArray, CachedTypedValueArray selectorTa,
